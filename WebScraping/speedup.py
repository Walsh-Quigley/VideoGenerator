...
def speedUp():
    ...
    file_path1 = r"c:/Users/Walsh Quigley/Desktop/PersonalProjects/WebScraping/narration/rawTitle.mp3"
    # Load the audio file
    audio = AudioSegment.from_file(file_path1, "mp3")
    new_title = speedup(audio, 1.1 , 110)
    

    file_path2 = r"c:/Users/Walsh Quigley/Desktop/PersonalProjects/WebScraping/narration/rawBody.mp3"
